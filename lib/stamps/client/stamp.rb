  ...
  class Client
    ...
    module Stamp
      ...
      def create!(params = {})
        ...
        update_authenticator(response, :create_indicium_response)
      ...
      def cancel!(params = {})
        ...
        update_authenticator(response, :cancel_indicium_response)
      ...
      def track(stamps_transaction_id)
        ...
        update_authenticator(response, :track_shipment_response)
